...
{
    /// <summary>
    /// This class exports all kinds of items to the Word format.
    /// Note: This is very unstructured, "on-the-fly" and large portions
    ///       are originally generated by ChatGPT, Copilot (shout-out!)
    /// </summary>
    public class ExportWord
    {
        protected YamlConfig.ExportConfig _config = new YamlConfig.ExportConfig();

        public ExportWord(YamlConfig.ExportConfig config)
        {
            _config = config;
        }
        ...
        public void ExportOverviewOperation(
            MainDocumentPart mainPart,
            List<ExportWord.OperationTuple> opTuples)
        {
            // access
            Body? body = mainPart.Document.Body;
            if (body == null)
